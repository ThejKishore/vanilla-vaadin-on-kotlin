package com.example.karibudsl.com.tk.template.themes
...
enum class MaterialSymbol {
    ...
    fun create(vararg classNames: String?): Span {
        val icon: Span =
            Span((if (this.name.startsWith("_")) this.name.substring(1) else this.name).lowercase(Locale.getDefault()))
    ...
    companion object {
        const val MATERIAL_ICONS: String = "material-symbols"
    }
}